//
//  ScrcpyCameraExtensionProvider.swift
...
class ScrcpyCameraExtensionDeviceSource: NSObject, CMIOExtensionDeviceSource {
	
	private(set) var device: CMIOExtensionDevice!
	
	private var _streamSource: ScrcpyCameraExtensionStreamSource!
	...
	init(localizedName: String) {
		...
		_streamSource = ScrcpyCameraExtensionStreamSource(localizedName: "SampleCapture.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class ScrcpyCameraExtensionStreamSource: NSObject, CMIOExtensionStreamSource {
	...
	func startStream() throws {
		...
		guard let deviceSource = device.source as? ScrcpyCameraExtensionDeviceSource else {
...
class ScrcpyCameraExtensionProviderSource: NSObject, CMIOExtensionProviderSource {
	
	private(set) var provider: CMIOExtensionProvider!
	
	private var deviceSource: ScrcpyCameraExtensionDeviceSource!
	...
	init(clientQueue: DispatchQueue?) {
		...
		deviceSource = ScrcpyCameraExtensionDeviceSource(localizedName: "SampleCapture (Swift)")
